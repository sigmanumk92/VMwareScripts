...
#>
Function SRM-AlarmsProtectedVMRemoved {
 [CmdletBinding()]
    Param(
...
$alarm.Name = "SRM Protected VM Removed $SRMinstance"

$alarm.Description = "SRM Protected VM Removed for $SRMinstance."
...
$expression1.eventTypeId = "Protected VM Deleted ($SRMinstance)"
