<#
.SYNOPSIS
Creates the Alarm For the Protected VMs being Restored
.DESCRIPTION
This script Creates the Alarm For Protected VMs being Restored.
.NOTES
Author: Anthony Schulte
#>
Function SRM-AlarmsVMProtRestore {
 [CmdletBinding()]
    Param(
...
$alarm.Name = "SRM Vm Protection Restored"

$alarm.Description = "Datastore is not Protected."
...
$expression1.eventTypeId = "com.vmware.vcDr.SPVmProtRestoredEvent"
