<#
.SYNOPSIS
Creates the Alarm For the Protected VMs deleted
.DESCRIPTION
This script Creates the Alarm For Protected VMs being deleted.
.NOTES
Author: Anthony Schulte
#>
Function SRM-AlarmsProdVMdel {
 [CmdletBinding()]
    Param(
...
$alarm.Name = "Production VM was Deleted"

$alarm.Description = "Virtual machine in group is deleted."
...
$expression1.eventTypeId = "com.vmware.vcDr.ProductionVmDeletedEvent"
