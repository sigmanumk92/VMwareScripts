<#
.SYNOPSIS
Creates the Alarm For the Replication unconfigured
.DESCRIPTION
This script Creates the Alarm For Replication unconfigured.
.NOTES
Author: Anthony Schulte
#>
Function SRM-VRRepunconfig {
 [CmdletBinding()]
    Param(
...
$alarm.Name = "VR VM Replication unconfigured"

$alarm.Description = "VR VM Replication unconfigured."
...
$expression1.eventTypeId = "com.vmware.vcHms.replicationUnconfiguredEvent"
